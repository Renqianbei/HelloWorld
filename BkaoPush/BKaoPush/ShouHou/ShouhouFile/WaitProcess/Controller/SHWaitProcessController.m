...
@interface SHWaitProcessController () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation SHWaitProcessController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_myDataSource) {
        ...
        cell.clickCheckButtonBlock = ^(NSString *string) {
            ...
            detailVc.markString = @"waitProcess";
