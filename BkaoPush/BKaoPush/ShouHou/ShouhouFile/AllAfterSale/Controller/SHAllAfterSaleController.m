...
@interface SHAllAfterSaleController () <UITableViewDelegate, UITableViewDataSource>

@end

@implementation SHAllAfterSaleController
{
...
- (void)requireMyDataSource
{
    ...
    for (NSInteger i = 0; i < 5; i++) {
        ShouHouModel *model = [[ShouHouModel alloc] initWithDictionary:@{@"order":@"订单号：654321354321", @"apply":@"申请时间：2016.09.27 11:25", @"require":@"售后要求：七天质量退货", @"trade":@"Apple iPhone 6 Plus(A154)64G 深空灰色"}];
