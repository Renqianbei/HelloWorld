...
#import "KPYiQueRenTableViewCell.h"
#import "KPZiXingPeiSongTableViewCell.h"

@interface KPYiJieViewController (){
    
    KPYiQueRenTableViewCell *cell;  // 第三方送达
    KPZiXingPeiSongTableViewCell  *cell1;  //自行送达
...
@implementation KPYiJieViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (a) {
        ...
        if (!cell1) {
            cell1 = [[KPZiXingPeiSongTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
        }
        
        cell1.selectionStyle= UITableViewCellAccessoryNone;
        [cell1 cateateDataSource:nil];
        ...
        if (!cell) {
            cell = [[KPYiQueRenTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
        }
