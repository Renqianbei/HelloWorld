//
//  KPZiXingPeiSongTableViewCell.h
//  BKaoPush
//
...
@protocol KPLYQueRenSongDaActiondelegate <NSObject>

-(void)KPLYQueRenSongDaAction:(UIButton *)button;

@end

@interface KPZiXingPeiSongTableViewCell : UITableViewCell
...
@property (nonatomic  ,retain) UILabel   *disanfang;//第三方运送

@property (nonatomic  ,retain) UILabel   *disanjiaqian;//第三放运费价钱

@property (nonatomic  ,retain) UIButton   *queRenBtn;  //  自己行配送 按钮 

@property (nonatomic  ,assign) id<KPLYQueRenSongDaActiondelegate>delegates;
