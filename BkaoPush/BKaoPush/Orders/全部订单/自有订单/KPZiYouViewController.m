...
@interface KPZiYouViewController ()
{
    KPZiYouTableViewCell *cell;
...
@implementation KPZiYouViewController
...
-(void)headButtonOnclick:(UIButton *)button
{
    ...
    //获取组的值
    NSInteger section = button.tag - 122123;
    //获取到当前的tableview
    UITableView * tv = (id)[self.view viewWithTag:1032];
    if ([_showSection[section] boolValue]==NO) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        cell = [[KPZiYouTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
