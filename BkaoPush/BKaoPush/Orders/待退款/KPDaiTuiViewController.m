...
@interface KPDaiTuiViewController ()
{
    KPTuiKuanTableViewCell *cell;
...
@implementation KPDaiTuiViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        cell = [[KPTuiKuanTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
